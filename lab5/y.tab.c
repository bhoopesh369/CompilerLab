...
void dowhile2()
{
 	printf("if %s goto Lbl\n%d",st1[top--],label[ltop--]);
}
void for1()
{
	label_num++;
...
static const yytype_int16 yyrline[] =
{
     ...
     289,   289,   289,   289,   306,   310,   311,   316,   370,   371,
     374,   374,   374,   374,   405,   423,   453,   454,   458,   462,
     465,   465,   468,   468,   469,   469,   470,   471,   471,   471,
     472,   472,   472,   473,   473,   473,   474,   474,   474,   475,
     475,   475,   476,   476,   476,   477,   477,   477,   478,   478,
     478,   479,   479,   479,   480,   482,   482,   483,   483,   484,
     486,   487,   487,   488,   489
};
#endif
...
#line 183 "parser.y"
	...
	{
		printf("\nError : Type mismatch : Line %d",printline());
	}
	...
	if (!(strcmp((yyvsp[-3].str),"printf") && strcmp((yyvsp[-3].str),"scanf") && strcmp((yyvsp[-3].str),"getc") && strcmp((yyvsp[-3].str),"gets") && strcmp((yyvsp[-3].str),"getchar") && strcmp	((yyvsp[-3].str),"puts") && strcmp((yyvsp[-3].str),"putchar") && strcmp((yyvsp[-3].str),"clearerr") && strcmp((yyvsp[-3].str),"getw") && strcmp((yyvsp[-3].str),"putw") && strcmp((yyvsp[-3].str),"putc") && strcmp((yyvsp[-3].str),"rewind") && strcmp((yyvsp[-3].str),"sprint") && strcmp((yyvsp[-3].str),"sscanf") && strcmp((yyvsp[-3].str),"remove") && strcmp((yyvsp[-3].str),"fflush")))
		printf("\nError : Type mismatch in redeclaration of %s : Line %d",(yyvsp[-3].str),printline());
	else
	{
		insert((yyvsp[-3].str),FUNCTION,yylineno);
		insert((yyvsp[-3].str),(yyvsp[-4].ival),yylineno);
		g_addr+=4;
	}
	}
#line 1694 "y.tab.c"
...
#line 202 "parser.y"
	...
	{
		printf("\nError : Type mismatch : Line %d",printline()); errc++;
	}
	...
	{printf("\nError : Redeclaration of %s : Line %d",(yyvsp[-4].str),printline());errc++;}
	else
	{
		insert((yyvsp[-4].str),FUNCTION,yylineno);
		insert((yyvsp[-4].str),(yyvsp[-5].ival),yylineno);
		for(j=0;j<=k;j++)
...
#line 1716 "y.tab.c"
  ...
  case 10:
#line 225 "parser.y"
                    {plist[++k]=(yyvsp[-1].ival);insert((yyvsp[0].str),(yyvsp[-1].ival),yylineno);insertscope((yyvsp[0].str),i);}
#line 1722 "y.tab.c"
    break;
...
#line 306 "parser.y"
					...
					if(lookup((yyvsp[-2].str)))
						printf("\nUndeclared Variable %s : Line %d",(yyvsp[-2].str),printline());
				}
#line 1870 "y.tab.c"
    break;
...
#line 311 "parser.y"
		...
		if(lookup((yyvsp[0].str)))
			printf("\nUndeclared Variable %s : Line %d",(yyvsp[0].str),printline());
		}
#line 1879 "y.tab.c"
    break;
...
#line 375 "parser.y"
		...
		if(!lookup((yyvsp[-6].str)))
		{
			...
			if(currscope==previous_scope)
				printf("\nError : Redeclaration of %s : Line %d",(yyvsp[-6].str),printline());
			else
			{
		...
		else
		{
			...
			insert((yyvsp[-6].str),(yyvsp[-7].ival),yylineno);
...
#line 405 "parser.y"
				...
				if(!lookup((yyvsp[-1].str)))
				{
					...
					if(!(scope<=currscope && end[scope]==0) || scope==0)
						printf("\nError : Variable %s out of scope : Line %d",(yyvsp[-1].str),printline());
				}
				else
					printf("\nError : Undeclared Variable %s : Line %d",(yyvsp[-1].str),printline());
				}
#line 1947 "y.tab.c"
    break;
...
#line 423 "parser.y"
			...
			if(itype!=258)
			{ printf("\nError : Array index must be of type int : Line %d",printline());errc++;}
			if(atoi((yyvsp[-2].str))<=0)
			{ printf("\nError : Array index must be of type int > 0 : Line %d",printline());errc++;}
			...
			else
			{
				...
				insert((yyvsp[-4].str),ARRAY,yylineno);
				insert((yyvsp[-4].str),(yyvsp[-5].ival),yylineno);
...
#line 454 "parser.y"
                                            {
						insert((yyvsp[-4].str),STRUCT,yylineno);
						g_addr+=4;
						}
#line 1990 "y.tab.c"
    break;
...
#line 458 "parser.y"
                           {
				insert((yyvsp[-1].str),STRUCT_VAR,yylineno);
				g_addr+=4;
				}
#line 1999 "y.tab.c"
    break;
